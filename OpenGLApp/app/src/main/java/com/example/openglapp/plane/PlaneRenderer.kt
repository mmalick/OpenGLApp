...
class PlaneRenderer(private val context: Context, private val objFileName: String, private val mtlFileName: String) : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(unused: GL10?, config: EGLConfig?) {
        ...
        mPlane = Plane(context, objFileName, mtlFileName)
    }
